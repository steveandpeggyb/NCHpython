...
def main(urls):
    ...
    logging.basicConfig(level=logging.WARNING, filename='C:\\Users\\csb003\\Documents\\NCHpython\\WebMonitoring\\checksites.log', 
            format='%(asctime)s %(levelname)s: %(message)s', 
            datefmt='%Y-%m-%d %H:%M:%S')
    
    # Load previous data
    pickle_file = 'C:\\Users\\csb003\\Documents\\NCHpython\\WebMonitoring\\data.pkl'
...
if __name__ == '__main__':
    ...
    # main(sys.argv[1:])
    main('www.nationwidechildrens.org')
